...
import monika
from monika.lib.curve.ttypes import *
...
cl = monika.LINE()
#cl.login(qr=True)
cl.login(token='Er7CQsAMXHd8byRvjohd.T+LoDe0A6jcy2jWFfEEhJq.aVVVXcohYzGmeTx/y3Cplxf7jGMjVluK8xi/xi7lE0w=')
cl.loginResult()
...
Bots=[mid]
owner=["u9e36c0029c31e1c1d6c36a8a7c13ff37",mid]
admin=["u9e36c0029c31e1c1d6c36a8a7c13ff37",mid]
baby=["u9e36c0029c31e1c1d6c36a8a7c13ff37"]
creator=["u9e36c0029c31e1c1d6c36a8a7c13ff37"]
...
wait = {
    ...
    "lang":"JP",
    "comment":"""Bot Auto Like By : Monika\nContact Me : line.me/ti/p/~syifaabyananta""",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
    ...
    try:
        ...
        if op.type == 13:
            if wait["auto"] == True:
                ...
                cl.sendText(op.param1, "Terima Kasih Telah Invite 👉😊☆º°˚˚☆✰ Monika BOT ✰☆º°˚˚☆（＾ω＾）\n\nby Monika ⭐👈\n»»» http://line.me/ti/p/~syifaabyananta\n\nSilahkan ketik [Help],dan gunakan dgn bijak")
        if op.type == 5:
...
##--------------------------
                ...
                if msg.from_ in admin or owner:
                    ...
                    with requests.session() as web:
                        ...
                        r = web.get("https://farzain.xyz/api/joox.php?apikey=BU1mldWd8HWmUYKa98ysPM5ApYAoSl&id={}" + urllib2.quote(search))
                        try:
                            data = json.loads(r.text)                            
                            ret_ = "╔══[ Music ]"
                            ret_ += "\n╠ Nama lagu : "+str(data["info"]["judul"])
                            ret_ += "\n╠ Durasi : "+str(data["info"]["penyanyi"])         
                            ret_ += "\n╠ Link : "+str(data["info"]["album"])
                            ret_ += "\n╚══[ Reading Audio ]"
                            cl.sendText(msg.to, str(ret_))
                            cl.sendAudioWithURL(msg.to,str(data["audio"]["mp3"]))
                        except:
