...
╚═════════════════
"""
wira="uecc57cb55f480ee2a45d81434a9b864d","uc99a2ab255130014a4ca4f3c3d9dad00"
...
Creator=["isi_mid_kamu","uecc57cb55f480ee2a45d81434a9b864d"]
admin=["isi_mid_kamu","uecc57cb55f480ee2a45d81434a9b864d"]
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
		...
		if wait["Simi"] == True: md+="╠➩✔️ Simisimi : On\n"
            ...
            elif msg.text in ["YUD1 Gift","YUD1 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': '696d7046-843b-4ed0-8aac-3113ed6c0733',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '6'}
            ...
            elif msg.text in ["YUD2 Gift","YUD2 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["YUD3 Gift","YUD3 gift"]:
                msg.contentType = 9
		...
		cl.sendText(msg.to,"Pasukan Absen!!")
                ki.sendText(msg.to,"YUD1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"YUD2 Hadiir  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"YUD3 Hadiir  \(ˆ▿ˆ)/")
		...
		if msg.from_ in Creator:
		    ...
		    cl.sendText(msg.to,"Lu sape!")
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"☆Jangan lupa add oa creator kami☆\n☆https://line.me/ti/p/~@ikj9968f☆") 
...
#              if msg.from_ in admin:
            ...
            elif msg.text in ["YUD1 acc invite"]:
                if msg.from_ in admin:
                    gid = ki.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["YUD2 acc invite"]:
                if msg.from_ in admin:
                    gid = kk.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["YUD3 acc invite"]:
                if msg.from_ in admin:
                    gid = kc.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["YUD4 acc invite"]:
                if msg.from_ in admin:
